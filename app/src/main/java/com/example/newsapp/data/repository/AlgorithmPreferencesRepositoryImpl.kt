...
@Singleton
class AlgorithmPreferencesRepositoryImpl @Inject constructor(
    @AlgorithmDataStore private val dataStore: DataStore<Preferences>,
    private val firestoreSyncManager: FirestoreSyncManager
) : AlgorithmPreferencesRepository {
    companion object {
    ...
    override val preferences: Flow<Map<String, Float>> = dataStore.data.map { prefs ->
        mapOf(
    ...
    override suspend fun updatePreferences(tech: Float, politics: Float, global: Float, business: Float, health: Float) {
