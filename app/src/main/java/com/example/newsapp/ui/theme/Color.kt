...
val BackgroundDark       = Color(0xFF15120D)
val SurfaceDark          = Color(0xFF15120D)
val SurfaceDimDark       = Color(0xFF100E0A)
val SurfaceBrightDark    = Color(0xFF423B2D)
val SurfaceContainerLowestDark  = Color(0xFF0C0A07)
val SurfaceContainerLowDark     = Color(0xFF1D1A13)
val SurfaceContainerDark        = Color(0xFF25211A)
val SurfaceContainerHighDark    = Color(0xFF2E2920)
val SurfaceContainerHighestDark = Color(0xFF383224)
...
val OutlineDark          = Color(0xFF4A4338)
val OutlineVariantDark   = Color(0xFF2F2B23)
