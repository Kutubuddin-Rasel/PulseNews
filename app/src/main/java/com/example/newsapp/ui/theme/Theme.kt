...
private val HighContrastDarkColorScheme = darkColorScheme(
    primary = Color(0xFFD8E0FF), // Bright Ice Cobalt
    onPrimary = Color(0xFF000B33),
    primaryContainer = Color(0xFF2E4BDE), // Strong Cobalt
    onPrimaryContainer = Color(0xFFFFFFFF),
    secondary = Color(0xFFFFC4B3), // Bright Coral
    onSecondary = Color(0xFF3B1002),
    secondaryContainer = Color(0xFFB25738), // Strong Terracotta
...
private val HighContrastLightColorScheme = lightColorScheme(
    primary = Color(0xFF102175), // Deep Cobalt
    onPrimary = Color(0xFFFFFFFF),
    primaryContainer = Color(0xFFDCE2FF),
    onPrimaryContainer = Color(0xFF000720),
    secondary = Color(0xFF8B3317), // Deep Terracotta
    onSecondary = Color(0xFFFFFFFF),
    secondaryContainer = Color(0xFFFFDBCD),
    onSecondaryContainer = Color(0xFF250900),
